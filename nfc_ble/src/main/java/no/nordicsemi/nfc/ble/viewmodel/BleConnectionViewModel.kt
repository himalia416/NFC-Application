package no.nordicsemi.nfc.ble.viewmodel
...
import no.nordicsemi.nfc.ble.NfcBleDeviceDestinationId
import no.nordicsemi.nfc.ble.repository.ConnectBluetoothLe

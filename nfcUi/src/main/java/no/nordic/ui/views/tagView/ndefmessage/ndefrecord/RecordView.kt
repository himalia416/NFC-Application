package no.nordic.ui.views.tagView.ndefmessage.ndefrecord
...
import no.nordic.ui.views.tagView.ndefmessage.ndefrecord.external.DisplayGenericExternalTypeRecord
import no.nordic.ui.views.tagView.ndefmessage.ndefrecord.handover.DisplayHandoverCarrierRecord
import no.nordic.ui.views.tagView.ndefmessage.ndefrecord.handover.DisplayHandoverReceiveRecord
import no.nordic.ui.views.tagView.ndefmessage.ndefrecord.handover.DisplayHandoverSelectRecord
import no.nordic.ui.views.tagView.ndefmessage.ndefrecord.handover.DisplayAlternativeCarrierRecord
import no.nordic.ui.views.tagView.ndefmessage.ndefrecord.external.DisplayAndroidPackageRecord
import no.nordic.ui.views.tagView.ndefmessage.ndefrecord.wellknown.DisplayMimeTypeRecord
import no.nordic.ui.views.tagView.ndefmessage.ndefrecord.wellknown.DisplaySmartPosterRecord
import no.nordic.ui.views.tagView.ndefmessage.ndefrecord.wellknown.DisplayTextRecord
import no.nordic.ui.views.tagView.ndefmessage.ndefrecord.wellknown.DisplayUriRecord
...
@Composable
fun RecordView(ndefRecords: List<NfcNdefRecord>) {
    OutlinedCard(
        modifier = Modifier
            .fillMaxWidth()
            .padding(8.dp)

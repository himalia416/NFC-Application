...
import no.nordicsemi.nfc.settings.navigation.NfcSettingsWithTag
import no.nordicsemi.nfc.settings.views.NavigateUp
import no.nordicsemi.nfc.settings.views.OnAboutAppClick
import no.nordicsemi.nfc.settings.views.OnAboutNfcClick
import no.nordicsemi.nfc.settings.views.OnEmailClick
import no.nordicsemi.nfc.settings.views.OnExportScanResultClick
import no.nordicsemi.nfc.settings.views.OnImportScanClick
import no.nordicsemi.nfc.settings.views.OnPlaySoundClick
import no.nordicsemi.nfc.settings.views.OnScanHistoryClick
import no.nordicsemi.nfc.settings.views.OnVibrateClick
import no.nordicsemi.nfc.settings.views.SettingsScreenViewEvent
